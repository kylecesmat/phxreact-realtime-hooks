...
const Box = ({ text, width = 'auto', pulseSpeed }) => (<div css={{ backgroundColor: '#657682', color: '#fff', flex: `1 1 ${width}`, margin: '5px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', animation: pulseSpeed ? `${pulse} ${pulseSpeed}ms ease infinite` : undefined }}>{text}</div>)
